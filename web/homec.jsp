<%-- 
    Document   : homec
    Created on : Feb 10, 2020, 11:52:14 AM
    Author     : nibu
--%>
...
<html>
  ...
  <div class="carousel-inner">
    ...
    <p>
        <button  type="submit"class="animated bounceInLeft btn btn-primary"style="animation-delay: 3s">Click Here Join With Us</button></p>
        </div>
